	...
	<div class="card-body ">
		<form action="index.php?action=updateMember" method="post">
			...
			<div class="form-group form-comment">
				<label for="text">Pseudo</label><br /> <input type="text"
					name="pseudo" value="<?= $resultat['pseudo'];?>" />
			</div>
			<div class="form-group form-comment">
				<label for="email">Email</label><br /> <input type="email"
					name="email" value="<?= $resultat['email'];?>" />
			</div>
			<div class="form-group form-comment">
			...
			<div class="form-group form-comment">
				<label for="text">niveau acces</label><br /> <input type="text"
					name="access_level" value="<?= $resultat['access_level'];?>" />
			</div>
			<div class="form-group form-comment">
